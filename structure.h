...
// Structure pour représenter un véhiculs
typedef struct
{
    int numero;
    int position;
...
enum EventType
{
    ...
    RETURN_CHARGE, // rentrée d’un véhicule
...
// L'heure à la quelle laes rechargement actuels seront finis
int get_debut_chargement(int *file_attente, int nb_vehicules);

// Surestimation du gain, a revoir
